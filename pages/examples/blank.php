  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Pedro Albuquerque</a>
        </div>
      </div>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">GERENCIAMENTO DE CARGOS</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title col-11">Tabela de cargos</h3>
                <button type="button" class="btn bg-success" data-toggle="modal" data-target="#staticBackdrop-INSERT">
              ...
              <table>
                <tr>
                  ...
                  <td class="col-3">CARGO</td>
                  <td class="col-2">TIPO DE CARGO</td>
                ...
                <?php foreach($lista as $cargo):?>
                    ...
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title" id="staticBackdropLabel">Inserir novo cargo</h5>
                  ...
                  <div class="modal fade" id="EDITAR<?=$cargo['ID_CARGO']?>" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title" id="staticBackdropLabel">modificar um cargo</h5>
                          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                          </button>
                        </div>
                          <form method="POST" action="editar_action.php">
                            <div class="modal-body">
                              <input type="hidden", name="id" class="id" value="<?=$cargo['ID_CARGO']?>"/>
                              <label for="nome">
                  ...
                  <!-- MODAL DELETE -->
                  <div class="modal fade" id="DELETAR<?=$cargo['ID_CARGO']?>" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title" id="staticBackdropLabel">EXCLUIR CARGO</h5>
                          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                          </button>
                        </div>
                          <form method="POST" action="deletar_action.php">
                            <div class="modal-body">
                              <h4>Tem certeza que deseja deletar o cargo<strong> <?=$cargo['NOME_CARGO']?></strong></h4>
                            </div>
                              <div class="modal-footer">
                                <input type="text" hidden name="id" value="<?=$cargo['ID_CARGO']?>">
